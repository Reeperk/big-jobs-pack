Locales['sv'] = {
  ...
  ['confirm_yes'] = 'ja',
  -- Service
  ['service_max'] = 'du kan inte gå tjänst, Yakuza i tjänst: %s/%s',
  ...
  ['being_searched'] = 'du blir ~y~visiterad~s~ av ~b~Yakuza~s~',
  -- Vehicle interaction
  ['vehicle_info'] = 'fordon',
