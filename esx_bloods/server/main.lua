...
RegisterNetEvent('esx_bloodsjob:confiscatePlayerItem')
...
RegisterNetEvent('esx_bloodsjob:getStockItem')
...
RegisterNetEvent('esx_bloodsjob:putStockItems')
...
ESX.RegisterServerCallback('esx_bloodsjob:getOtherPlayerData', function(source, cb, target, notify)
...
AddEventHandler('playerDropped', function()
	...
	if playerId then
		...
		if xPlayer and xPlayer.job.name == 'bloods' then
			Citizen.Wait(5000)
...
RegisterNetEvent('esx_bloodsjob:spawned')
...
RegisterNetEvent('esx_bloodsjob:forceBlip')
