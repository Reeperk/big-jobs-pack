...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{label = _U('bloods_wear'), uniform = grade}
	}
	...
	ESX.TriggerServerCallback('esx_bloodsjob:getFineList', function(fines)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fine_category', {
			...
			if Config.EnablePlayerManagement then
				TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_bloods', _U('fine_total', data.current.fineLabel), data.current.amount)
			else
...
function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('esx_bloodsjob:getOtherPlayerData', function(playerData)
...
AddEventHandler('esx_phone:cancelMessage', function(dispatchNumber)
	if ESX.PlayerData.job and ESX.PlayerData.job.name == 'bloods' and ESX.PlayerData.job.name == dispatchNumber then
...
AddEventHandler('esx_bloodsjob:hasEnteredEntityZone', function(entity)
	...
	if ESX.PlayerData.job and ESX.PlayerData.job.name == 'bloods' and IsPedOnFoot(playerPed) then
...
Citizen.CreateThread(function()
	while true do
		...
		if ESX.PlayerData.job and ESX.PlayerData.job.name == 'bloods' then
			local playerPed = PlayerPedId()
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction then
			...
			if IsControlJustReleased(0, 38) and ESX.PlayerData.job and ESX.PlayerData.job.name == 'bloods' then
		...
		if IsControlJustReleased(0, 167) and not isDead and ESX.PlayerData.job and ESX.PlayerData.job.name == 'bloods' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bloods_actions') then
			if not Config.EnableESXService then
