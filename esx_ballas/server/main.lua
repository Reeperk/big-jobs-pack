...
RegisterNetEvent('esx_ballasjob:getStockItem')
...
RegisterNetEvent('esx_ballasjob:putStockItems')
...
RegisterNetEvent('esx_ballasjob:spawned')
...
RegisterNetEvent('esx_ballasjob:forceBlip')
