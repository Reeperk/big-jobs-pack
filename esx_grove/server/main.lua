...
RegisterNetEvent('esx_grovejob:confiscatePlayerItem')
...
RegisterNetEvent('esx_grovejob:getStockItem')
...
RegisterNetEvent('esx_grovejob:putStockItems')
...
ESX.RegisterServerCallback('esx_grovejob:getOtherPlayerData', function(source, cb, target, notify)
...
AddEventHandler('playerDropped', function()
	...
	if playerId then
		...
		if xPlayer and xPlayer.job.name == 'grove' then
			Citizen.Wait(5000)
...
RegisterNetEvent('esx_grovejob:spawned')
...
RegisterNetEvent('esx_grovejob:forceBlip')
