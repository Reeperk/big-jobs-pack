...
RegisterNetEvent('esx_cripsjob:confiscatePlayerItem')
...
RegisterNetEvent('esx_cripsjob:getStockItem')
...
RegisterNetEvent('esx_cripsjob:putStockItems')
...
ESX.RegisterServerCallback('esx_cripsjob:getOtherPlayerData', function(source, cb, target, notify)
...
RegisterNetEvent('esx_cripsjob:spawned')
...
RegisterNetEvent('esx_cripsjob:forceBlip')
